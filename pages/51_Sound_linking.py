...
# ---------------- Page setup ----------------
st.set_page_config(page_title="Lecture Slide Player - Chapter 4", layout="wide")
st.markdown("#### 📗 Chapter 4: English vowels")
...
GITHUB_BRANCH = "main"
FOLDER_PATH   = "pages/lecture/Soundlinking"

FILENAME_PREFIX = "Sound_linking."
FILENAME_EXT    = ".png"
START_INDEX     = 1
END_INDEX       = 15
